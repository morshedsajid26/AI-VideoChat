...
const Banner = () => {
  return (
    <div cla className='bg-[url("/bannerLight.png")] dark:bg-[url("/bannerdark.png")] bg-cover bg-no-repeat bg-center pt-[50px] pb-[120px] '>
      <Container className="">
        <Navbar />
        ...
        <div className="text-center ">
          ...
          <div className="mt-5">
            <h3 className="font-inter font-bold text-[48px] flex flex-col items-center text-[#333333] dark:text-[#F1F1F1]">
              <span>AI</span>
              Video Chat Platform_ MVP</h3>
            <p className="font-onest text-[#6A7282] dark:text-[#C9C4C4] mt-4 text-center">AI Video Chat Platform is the next-generation AI assistant platform, designed to empower developers, creators, educators and businesses with seamless access to the most advanced language models, voice capabilities, and productivity tools. </p>
          </div>
          ...
          <button className="bg-[#0F172B] dark:bg-[#F1F1F1] mt-15 px-10 py-4 rounded text-white dark:text-black  hover:bg-[#314D91] transition-all duration-300 cursor-pointer">
           Try for free now
          </button>
        </div>
      </Container>
